...
Route::middleware(['auth', 'verified'])->prefix('tablero/ventas-inmueble')->group(function () {
    Route::get('/', [CollaboratorController::class, 'sales_property'])->name('collaborator.sales.property');
});

/*Sales publicity*/
Route::middleware(['auth', 'verified'])->prefix('tablero/ventas-publicidad')->group(function () {
...
Route::middleware(['auth', 'verified', 'role:Admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/colaborador/{id}', [AdminCollaboratorController::class, 'show_details'])->name('admin.collaborator.show');
    Route::post('/colaborador/alojamientos/store', [AdminCollaboratorController::class, 'store_lodging'])->name('admin.collaborator.lodging.store');
    Route::get('/colaborador/{id}/alojamientos', [AdminCollaboratorController::class, 'index_lodging'])->name('admin.collaborator.lodging');
    ...
    Route::post('/colaborador/recursos/request-displays', [AdminCollaboratorController::class, 'change_status_request_display'])->name('admin.collaborator.resource.request-displays');
    Route::post('/colaborador/recursos/received-displays', [AdminCollaboratorController::class, 'change_status_received_display'])->name('admin.collaborator.resource.received-displays');
