...
class CollaboratorController extends Controller
{
    ...
    public function store_shipping(Request $request){
        ...
        $id = mt_Rand(1000000, 9999999);
        return Redirect::route('collaborator.shipping.index')->with(['id'=>$id, 'message' => 'Saved successfully', 'code' => 200, 'status' => 'success']);
    }
    ...
    public function store_bank(Request $request){
        ...
        $id = mt_Rand(1000000, 9999999);
        return Redirect::route('collaborator.bank.index')->with(['id'=>$id, 'message' => 'Saved successfully', 'code' => 200, 'status' => 'success']);
    }
