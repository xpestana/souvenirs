        ...
        <div class="row m-auto justify-content-between">
            ...
            <div class="login-form-collaborator col-12 col-lg-6 bg-white shadow-lg rounded-xl">
                <div class="form-card bg-white p-4 lg:p-8 rounded-xl">
                    <form @submit.prevent="submit" class=" mt-10">
                        <h1 class="text-3xl lg:text-5xl mb-2 font-weight-bolder">Welcome to HiCitty!</h1>
                        <div class="my-1">
                        ...
                        <div class="row my-2 justify-content-center justify-content-lg-between">
                            <div class="form-remember col-10 col-lg-5 lg:pr-0 text-center text-lg-left">
                                <input type="checkbox" class="border mr-1 rounded-lg">
                                <p class="inline">Remember me</p>
                            </div>
                            <div class="forgot-password text-center text-lg-right  col-10 col-lg-6 lg:pl-0 pt-1">
                                <a href="javascript:void(0)" class="text-azulc"  data-toggle="modal" data-target="#forgot-password" >I forgot my password</a>
                            </div>
                        </div>
                        ...
                        <div class="my-3">
                            <button type="submit" class="btn btn-collaborator text-xl w-100" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                                <p class="text-xl mb-0">Log in</p>
                            </button>
                        </div>
                        <div class="my-2 text-center">
                            <p class="inline-block text-muted form-collaborator-text relative">You do not have an account yet?</p>
                        </div>
                        <div class="my-3">
                            <Link :href="route('collaborator.register')" class="btn btn-outline-collaborator text-xl w-100">Create an account</Link>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-content mx-auto">
                    <div class="modal-body p-0">
                        ...
                        <div class="row mb-2 justify-content-center">
                            <div class="col-12">
                                <h1 class="text-lg font-weight-bolder text-center">Reset your password</h1>
                            </div>
                            <div class="col-8 px-0 py-3 text-left">
                                ...
                                <input type="text" class="rounded border w-100 py-2" v-model="forgot.email" placeholder="Email..."  required autofocus autocomplete="username">                
                            </div>
                        </div>
                        ...
                        <div class="row mb-2 justify-content-center">
                            ...
                            <div class="col-8 px-0 py-3 text-left">
                                <p class="text-justify" v-if="$page.props.flash.mensaje">
                                    We have sent an email to {{$page.props.flash.message.email}} with a link
