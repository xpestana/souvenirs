        ...
        <div class="header row justify-content-between shadow p-2 rounded-xl bg-header-collaborator py-3">
            ...
            <div class="col-8 col-md-4 text-right">
                <p class="leading-4">
                    ...
                    <span class="text-orangec" v-if="$page.props.auth.profile.firstname">{{$page.props.auth.profile.firstname}}</span>!
                </p>
            </div>
        </div>
        <!--END Header section-->
        ...
        <div class="home-perfil-full row mt-3.5 lg:mt-0" v-if="cont == 4 && hotels.length > 0">
            ...
            <div class="col-12 col-lg-6 pl-lg-0 pr-lg-3 lg:h-3/4">
                <div class="perfil-card w-full h-48 lg:h-full rounded-xl shadow 
                    ...
                    style="background-image: url('/vendor_asset/img/collaborator/dashboard/inicioenlazar.png');"
                >
                    <div class="absolute w-full h-full flex flex-column justify-between rounded-xl" style="background-color:#00000069">
                        <h2 class="font-bold text-2xl text-white p-3.5"> Enlaza todos los servicios que ofreces</h2>
