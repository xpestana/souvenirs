    ...
    <div id="dashboard-perfil-bank" class="container  py-8 ml-2 md:ml-0 md:px-24" :class="{'position-relative': windowWidth < 768}">
        ...
        <div class="breadcrumb-associate row mx-1.5 lg:mx-0 py-3">
            <div class="col-12 text-left px-0">
                <p class="text-gray-500">Gestión de partners / {{user.profile.firstname}} / <b>Información bancaria</b></p>
            </div>
        </div>
         <!--END Header-->
        <!--Formulario de banck -->
...
export default {
    ...
    methods: {
        submit () {
            ...
            this.formCollaboratorBank.post(route('admin.associate.update.bank'), {
                preserveScroll: true,
                errorBag: 'submitBank',
                onSuccess:()=>{
