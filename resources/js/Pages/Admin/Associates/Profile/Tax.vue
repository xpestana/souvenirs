    ...
    <section id="dashboard-perfil-tax" class="container py-8 ml-2 md:ml-0 md:px-24">
        ...
        <div class="breadcrumb-associate row mx-1.5 lg:mx-0 py-3">
            <div class="col-12 text-left px-0">
                <p class="text-gray-500">Gestión de partners / {{user.profile.firstname}} / <b>Datos fiscales</b></p>
            </div>
        </div>
        <!--END Header section-->
         <!-- Content section-->
        <div class="perfil-tax row mx-1.5 lg:mx-0">
...
export default {
    ...
    methods: {
        submitProfile() {
            ...
            this.form.post(route('admin.associate.update.tax'), {
                preserveScroll: true,
                errorBag: 'submitTax',
                onSuccess:()=>{
