			...
			<div class="row ficha mx-lg-4 my-4 p-2 bg-light border">
				<div class="col-12">
					<div class="d-flex flex-column flex-md-row justify-content-md-between">
						<h1 class="pt-1 pb-2 font-weight-bolder text-center text-md-left">Nombre</h1>
						<p class="font-weight-bolder text-muted mt-md-3 mr-3 text-center text-md-right">usuario@email.com</p>
					</div>
        ...
        <section id="alojamiento">
            <div class="row mx-lg-4 mb-2 detalles justify-content-start">
                <div class="col-10 col-6">
                    <p class="text-muted text-uppercase">apartamento</p>
                    <h1 class="font-weight-bolder">Piso C/Real N. Planta 2</h1>
                </div>
            </div>
            ...
            <div class="row mx-lg-4 my-3 justify-content-center justify-content-md-end">
                ...
                <div class="col-8 col-sm-4 col-md-8 text-center text-md-right">
                    <button class="btn btn-danger-c rounded-pill py-0 mt-1 mt-sm-0 mt-md-2" type="submit">Eliminar apartamento</button>
                </div>
            </div>
            </form>
        </section>
