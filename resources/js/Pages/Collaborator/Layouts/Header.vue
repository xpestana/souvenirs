...
<script>
    ...
    import Menu from '@/Pages/Collaborator/Layouts/Menu.vue'
	import MobileMenu from '@/Pages/Collaborator/Layouts/Menu-mobile.vue'
...
<style>
    ...
    .cart-area > ul > li > i.header-search{
            font-size: 28px;
        }
        .cart-area > ul > li > a i.header-cart{
            font-size: 28px;
        }
        .cart-area > ul > li{
