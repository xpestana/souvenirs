<template>
	<!-- Modal Request -->
    <div class="modal modal-create fade" id="create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <!-- Change class .modal-sm to change the size of the modal -->
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content modal-create-lodging modal mx-auto px-2">
                <div class="modal-body p-0">
                    <h2 class="text-lg md:text-3xl text-center mt-3.5 font-bold">¿Que tipo de inmueble vas a registrar?</h2>
                    	...
                    	<div class="col-12 col-md-3 md:mr-2">
                    		...
                    		>
                    			<img class="block w-12" style=""
			                        src="/vendor_asset/img/collaborator/dashboard/icons/lodging/HotelAzul.svg"
			                    >
                    ...
                    <div class="my-2.5 flex justify-content-between">
                        <button class="btn px-3.5 py-1 text-xs font-bold" data-dismiss="modal"  aria-label="Close">Volver</button>
                    </div>
                </div>
            </div>
        </div>
