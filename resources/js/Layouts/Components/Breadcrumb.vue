<template>
    ...
    <div class="breadcrumb-area pt-65 pb-70 bg-img h-52" :class="{'opacity-50 md:opacity-100':this.title=='Souvenirs'}" :style="'background-image:url(/vendor_asset/img/bg-image/'+img+');'">
        <div class="container">
            <div class="breadcrumb-wrap text-center hidden md:block">
                <h3>{{ this.title }}</h3>
    ...
    <div class="absolute md:hidden top-20 left-0 right-0 text-center">
